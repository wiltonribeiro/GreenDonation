...
public class BaseAdapterDoacaoEntregue extends BaseAdapter {
    List<Notificacao> myList = new ArrayList<>();
    LayoutInflater inflater;
    Context context;
    MyViewHolder mViewHolder;

    public BaseAdapterDoacaoEntregue(Context context, List<Notificacao> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.layout_doacao_entregue, parent, false);
        ...
        mViewHolder.tvDoador.setText(("Doador: "+currentListData.getDoacao().getDoador().getNome()));
        mViewHolder.tvReceptor.setText(("Receptor: "+currentListData.getSolicitacao().getColetador().getNome()));
    ...
    private class MyViewHolder {
        TextView tvRegiao, tvMaterial, tvPeso, tvDoador, tvReceptor, tvEmail;
        public MyViewHolder(View item) {
            ...
            tvReceptor = (TextView) item.findViewById(R.id.tvNome);
